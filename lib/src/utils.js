...
exports.getDate = exports.removeFileComment = exports.getLangMessages = exports.getLangPath = exports.checkI18NExpressionUsed = exports.readFile = exports.traverse = exports.isFile = exports.isDirectory = void 0;
...
function getLangPath(lang) {
    const langDir = config_1.getValFromConfiguration('langDir');
    return path_1.default.resolve(langDir, `${lang}.json`);
}
