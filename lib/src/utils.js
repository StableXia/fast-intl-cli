...
exports.compatESModuleRequire = exports.winPath = exports.getFileToJson = exports.getDate = exports.removeFileComment = exports.getLangMessages = exports.getLangDir = exports.checkI18NExpressionUsed = exports.readFile = exports.traverse = exports.isFile = exports.isDirectory = void 0;
...
function getLangDir(lang) {
    ...
    return path_1.default.resolve(config.langDir, lang);
}
exports.getLangDir = getLangDir;
function getLangMessages(lang, filter = (message, key) => true) {
    const srcLangDir = getLangDir(lang);
    let files = fs_1.default.readdirSync(srcLangDir);
    files = files
        .filter((file) => file.endsWith('.ts') && file !== 'index.ts')
        .map((file) => path_1.default.resolve(srcLangDir, file));
