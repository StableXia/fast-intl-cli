...
function exportChineseText(allChineseText, exportDir) {
    ...
    const fileName = `zh-${utils_2.getDate()}.json`;
    fs_1.default.writeFileSync(path_1.default.join(dir, fileName), JSON.stringify(temp, null, 2));
    view_1.log.primary(view_1.log.chalk.green(`文案已导入${fileName}`));
}
